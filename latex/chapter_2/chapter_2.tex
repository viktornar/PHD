...
--		\includegraphics[width=0.9\linewidth]{images/seq_exec.png}
	...
	In many cases, the detectCore () function can be used in an R programming language to try to determine the amount of CPU logical cores in a computer (Tjhi W. et al., 2017).
